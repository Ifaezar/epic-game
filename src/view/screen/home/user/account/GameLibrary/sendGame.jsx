...
class SendGame extends React.Component {
    ...
    getGameLibrary = () => {
        Axios.get(`${API_URL}/gameLibrary/gameLibraryById/${this.props.match.params.gameLibraryId}`)
            .then((res) => {
...
export default connect(mapsStateToProps)(SendGame)