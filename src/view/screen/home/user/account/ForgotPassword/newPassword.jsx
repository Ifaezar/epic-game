...
class NewPassword extends React.Component {
    ...
    componentDidMount() {
        Axios.get(`${API_URL}/users/password/${this.props.match.params.email}/${this.props.match.params.id}`)
            .then((res) => {
            ...
            <div>
                <div className="auth-screen">
                    <div className="auth-form">
                        ...
                        <input type="button" value="Change Password" className="login-btn active" onClick={this.savePassword} ></input>
