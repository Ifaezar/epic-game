                ...
                <div className="auth-form">
                    ...
                    <h6>Sign in</h6>
                    {
                        this.props.user.errMsg ? (
                            <div className="textboxErr">
                                <h6>{this.props.user.errMsg}</h6>
                            </div>
                        ) : (
                    ...
                    <form action="">
                        <div className="textbox">
                            <input type="text" placeholder="Username or Email" onChange={(e) => { this.inputHandler(e, "username") }} />
                        ...
                        {
                            username && password ? (
                                <input type="button" value="Continue" className="login-btn active" onClick={this.loginHandler} ></input>
                            )
